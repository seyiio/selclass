...
public class RabbitMQTopicConfig {
    ...
    private static final String QUEUE = "selclassQueue";
    private static final String EXCHANGE = "selclassExchange";
    ...
    public Binding binding() {
        return BindingBuilder.bind(queue()).to(topicExchange()).with("selclass.#");
    }

    @Bean
    public Binding Respbinding() {
        return BindingBuilder.bind(queueResp()).to(topicExchange()).with("resp.#");
    }
